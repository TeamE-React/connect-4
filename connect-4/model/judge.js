...
export class Judge{
  ...
  checkWinner(){
    ...
    return(
      this.verticalCheck(rowIndex, colIndex) || this.horizontalCheck(rowIndex, colIndex) || this.rightDiagonalCheck(rowIndex, colIndex) || this.leftDiagonalCheck(rowIndex, colIndex)
    );
  }
  ...
  isBothSameColor(ball1, ball2){
    if(ball1.color === null || ball2.color === null || ball1.color != ball2.color) return false;
    else return true;
  }
